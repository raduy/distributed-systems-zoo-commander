        ...
        try {              
            ...
            for(int i = 1; i <= ops; i++){
                ...
                zkDb.processTxn(new TxnHeader(13,1000+i,zxid,30+i,ZooDefs.OpCode.create), 
                                                new CreateTxn(path, "fpjwasalsohere".getBytes(), Ids.OPEN_ACL_UNSAFE, false, 1));
                Stat stat = new Stat();
        ...
        testFollowerConversation(new FollowerConversation() {
            ...
            public void converseWithFollower(InputArchive ia, OutputArchive oa,
                ...
                try {
                    ...
                    zkDb.processTxn(new TxnHeader(13, 1313, firstZxid, 33, ZooDefs.OpCode.create), new CreateTxn("/foo", "data1".getBytes(), Ids.OPEN_ACL_UNSAFE, false, 1));
                    Stat stat = new Stat();
            ...
            public void converseWithObserver(InputArchive ia, OutputArchive oa,
                ...
                try {
                    ...
                    zkDb.processTxn(new TxnHeader(13, 1313, foo1Zxid, 33,
                            ...
                            "data1".getBytes(), Ids.OPEN_ACL_UNSAFE,
                            false, 1));
